...
Application under test is taken from a sample Markup : [spring-petclinic](https://github.com/singularity-sg/spring-petclinic). I have just decomposed the application into multiple modules to create a multimodule maven project.
...
<br/>-Dwebdriver.chrome.driver=/path/to/chromedriver. You can download chrome driver from Markup : [ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver/)
