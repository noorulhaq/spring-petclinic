...
* Access web application from any proxy server (Apache, Nginx) to avoid CORS issues. Refer to [sample] (https://github.com/noorulhaq/spring-petclinic/blob/master/assets/httpd.conf) configuration file provided in assests folder for apache web server.
