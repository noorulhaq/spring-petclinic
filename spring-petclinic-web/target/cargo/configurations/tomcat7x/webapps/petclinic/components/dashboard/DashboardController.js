...
if (! _$jscoverage['/main/webapp/components/dashboard/DashboardController.js']) {
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'] = {};
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].lineData = [];
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].lineData[1] = 0;
}
if (! _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].functionData) {
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].functionData = [];
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].functionData[0] = 0;
}
if (! _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].branchData) {
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].branchData = {};
}
_$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].lineData[1]++;
var DashboardController = ['$scope', function($scope) {
  _$jscoverage['/main/webapp/components/dashboard/DashboardController.js'].functionData[0]++;
}];
