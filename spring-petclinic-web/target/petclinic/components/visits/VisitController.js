...
if (! _$jscoverage['/main/webapp/components/visits/VisitController.js']) {
  _$jscoverage['/main/webapp/components/visits/VisitController.js'] = {};
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].lineData = [];
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].lineData[1] = 0;
}
if (! _$jscoverage['/main/webapp/components/visits/VisitController.js'].functionData) {
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].functionData = [];
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].functionData[0] = 0;
}
if (! _$jscoverage['/main/webapp/components/visits/VisitController.js'].branchData) {
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].branchData = {};
}
_$jscoverage['/main/webapp/components/visits/VisitController.js'].lineData[1]++;
var VisitController = ['$scope', function($scope) {
  _$jscoverage['/main/webapp/components/visits/VisitController.js'].functionData[0]++;
}];
